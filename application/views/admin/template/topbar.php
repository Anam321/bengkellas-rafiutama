                                        ...
                                        <div class="list-group list-group-flush list-group-reflow mb-2">
                                            ...
                                            <div class="list-group-item py-2">
                                                ...
                                                <div class="user-avatar user-avatar-sm bg-muted">
                                                    <img src="<?= base_url() ?>assets/backend/dashboard/images/avatars/bootstrap.svg" alt="">
                                                </div>
                                                <div class="ml-2">
                                            ...
                                            <div class="list-group-item py-2">
                                                <a href="#" class="stretched-link"><span class="sr-only">Go to search result</span></a>
                                                <div class="user-avatar user-avatar-sm bg-muted">
                                                    <img src="<?= base_url() ?>assets/backend/dashboard/images/avatars/slack.svg" alt="">
                                                </div>
                                                <div class="ml-2">
                                    ...
                                    <div class="dropdown-scroll perfect-scrollbar">
                                        ...
                                        <a href="#" class="dropdown-item unread">
                                            <div class="user-avatar">
                                                <img src="<?= base_url() ?>assets/backend/dashboard/images/avatars/uifaces15.jpg" alt="">
                                            </div>
                                        ...
                                        <a href="#" class="dropdown-item unread">
                                            <div class="user-avatar">
                                                <img src="<?= base_url() ?>assets/backend/dashboard/images/avatars/uifaces16.jpg" alt="">
                                            </div>
                                            <div class="dropdown-item-body">
                                        ...
                                        <a href="#" class="dropdown-item">
                                            <div class="user-avatar">
                                                <img src="<?= base_url() ?>assets/backend/dashboard/images/avatars/uifaces17.jpg" alt="">
                                            </div>
                                            <div class="dropdown-item-body">
                                        ...
                                        <a href="#" class="dropdown-item">
                                            <div class="user-avatar">
                                                <img src="<?= base_url() ?>assets/backend/dashboard/images/avatars/uifaces18.jpg" alt="">
                                            </div>
                                            <div class="dropdown-item-body">
                                        ...
                                        <a href="#" class="dropdown-item">
                                            <div class="user-avatar">
                                                <img src="<?= base_url() ?>assets/backend/dashboard/images/avatars/uifaces19.jpg" alt="">
                                            </div>
                                            <div class="dropdown-item-body">
                                        ...
                                        <a href="#" class="dropdown-item">
                                            <div class="user-avatar">
                                                <img src="<?= base_url() ?>assets/backend/dashboard/images/avatars/uifaces20.jpg" alt="">
                                            </div>
                                            <div class="dropdown-item-body">
                                        ...
                                        <a href="#" class="dropdown-item">
                                            <div class="user-avatar">
                                                <img src="<?= base_url() ?>assets/backend/dashboard/images/avatars/uifaces21.jpg" alt="">
                                            </div>
                                            <div class="dropdown-item-body">
                            ...
                            <li class="nav-item dropdown header-nav-dropdown has-notified">
                                ...
                                <div class="dropdown-menu dropdown-menu-rich dropdown-menu-right">
                                    ...
                                    <div class="dropdown-scroll perfect-scrollbar">
                                        ...
                                        <a href="#" class="dropdown-item unread">
                                            <div class="user-avatar">
                                                <img src="<?= base_url() ?>assets/backend/dashboard/images/avatars/team1.jpg" alt="">
                                            </div>
                                            <div class="dropdown-item-body">
                                        ...
                                        <a href="#" class="dropdown-item">
                                            <div class="user-avatar">
                                                <img src="<?= base_url() ?>assets/backend/dashboard/images/avatars/team3.png" alt="">
                                            </div>
                                            <div class="dropdown-item-body">
                                        ...
                                        <a href="#" class="dropdown-item">
                                            <div class="user-avatar">
                                                <img src="<?= base_url() ?>assets/backend/dashboard/images/avatars/team2.png" alt="">
                                            </div>
                                            <div class="dropdown-item-body">
